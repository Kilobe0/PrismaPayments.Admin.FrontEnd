...
- [ ] **MERCH-03**: Página de detalhe do merchant com abas: Info / KYC / Saldo / Configurações / Transações / Credenciais
...
- [ ] **MERCH-07**: Editar configurações do merchant: webhook URL, limites de saque, auto-withdrawal (role ADMIN+)
