<div style="padding: 32px; max-width: 1080px; margin: 0 auto;">
  <div style="margin-bottom: 32px;">
    ...
    <p style="color: #9090A8; font-size: 0.875rem; margin: 0;">
      Regras de taxas da plataforma
    </p>
  </div>
  <div style="background: #0F0F18; border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; padding: 32px; text-align: center;">
    <p style="color: #9090A8;">Em implementação...</p>
  </div>
</div>
